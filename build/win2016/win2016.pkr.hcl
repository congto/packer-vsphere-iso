...
source "vsphere-iso" "win2016dccore" {
    ...
    floppy_files = [
        "../../bootfiles/win2016/datacentercore/autounattend.xml",
...
source "vsphere-iso" "win2016dc" {
    ...
    floppy_files = [
        "../../bootfiles/win2016/datacenter/autounattend.xml",
        "../../scripts/common/install-vmtools64.cmd",
        "../../scripts/common/initial-setup.ps1"
    ]
...
source "vsphere-iso" "win2016stdcore" {
    ...
    floppy_files = [
        "../../bootfiles/win2016/standardcore/autounattend.xml",
        "../../scripts/common/install-vmtools64.cmd",
        "../../scripts/common/initial-setup.ps1"
    ]
...
source "vsphere-iso" "win2016std" {
    ...
    floppy_files = [
        "../../bootfiles/win2016/standard/autounattend.xml",
        "../../scripts/common/install-vmtools64.cmd",
        "../../scripts/common/initial-setup.ps1"
    ]
